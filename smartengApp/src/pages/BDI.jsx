...
const BDI = () => {
  ...
  return (
    <div className="w-full">
      <Header />
      <Main className="h-auto pb-16 pt-8 text-indigo-950 dark:text-violet-50">
        <Container className="mx-auto bg-violet-50 px-24 py-8">
          <div className="rounded-l-2xl contain-content">
            <table className="w-full text-left text-sm text-violet-500 dark:text-violet-200">
              <tbody>
                <tr>
                  <td className="bg-white px-6 text-xs font-bold uppercase text-indigo-950 dark:bg-violet-200">
                    FATOR BDI
                  </td>
                ...
                <tr>
                  <td className="border-t bg-violet-100 px-6 text-xs font-bold uppercase text-indigo-950 dark:bg-violet-300">
                    BDI
                  </td>
        ...
        <Container className="mx-auto mt-4 bg-violet-50 px-20 py-8">
          <div className="">
            <div className="mb-4 flex flex-row flex-wrap place-content-center gap-4 text-xl contain-content">
            ...
            <div className="flex flex-row flex-wrap place-content-center gap-4 rounded-xl contain-content">
              <table className="w-full text-left text-sm text-violet-500 dark:text-violet-200">
                <thead className="bg-white text-xs uppercase text-indigo-950 dark:bg-violet-200">
                  <tr>
                ...
                <tbody>
                  ...
                  <tr className="bg-white text-xs font-semibold uppercase text-indigo-950 dark:bg-violet-200">
                    <td className="border-t px-6 py-4">
              ...
              <div className="flex flex-row flex-wrap place-content-center text-xl contain-content">
              ...
              <table className="w-full text-left text-sm text-violet-500 dark:text-violet-200">
                <tbody>
                  <tr>
                    <td className="border-t bg-white px-6 text-xs font-bold uppercase text-indigo-950 dark:bg-violet-200">
                      COFINS
                    </td>
                    <td className="border-t px-6 py-4">
              ...
              <table className="mt-4 w-full text-left text-sm text-violet-500 dark:text-violet-200">
                <tbody>
                  <tr>
                    <td className="border-t bg-white px-6 text-xs font-bold uppercase text-indigo-950 dark:bg-violet-200">
                      Valor bruto
